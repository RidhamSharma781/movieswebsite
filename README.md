A web application that showcases the latest movies, their IMDb ratings, trailers, and allows users to search for different movies. Built with modern web technologies to provide a seamless user experience.
